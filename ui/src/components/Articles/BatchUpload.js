                ...
                <div className="form-group form-row">
                  <div className="col-md-6">
                    <label htmlFor="inputState" className="d-block">
                      Please choose a document type for the batch you want to
                      upload.
                    </label>
                    <Select
                      value={documentType}
                      ...
                      options={
                        this.state.article && this.state.article.type === 'sse'
                          ? SSE_DOCUMENT_TYPES
                          : HSE_DOCUMENT_TYPES
                      }
                      isSearchable
                ...
                <div className="form-group form-row">
                  <div className="col-md-6">
                    ...
                    <Select
                      ...
                      onChange={(value) =>
                        this.handleChange('selectedArticleSource', value)
                      }
                      options={
                        this.state.article && this.state.article.type === 'sse'
                          ? SSE_ARTICLE_SOURCES
                ...
                <div className="form-group form-row">
                  <div className="col-md-6">
                    ...
                    <Select
                      ...
                      onChange={(value) =>
                        this.handleChange('selectedLanguage', value)
                      }
                      options={LANGUAGES}
                      isSearchable
                    />
