...
module.exports = (app) => {
  app.get(
    '/hse/assignedpresentationdetailsarticlequeue',
    HSEAssignedPresentationDetailsArticleQueueController.listArticles,
  );
  app.get(
    '/hse/assignedpresentationdetailsarticlequeue/fetcharticle/:articleId',
    HSEAssignedPresentationDetailsArticleQueueController.fetchArticle,
  );
