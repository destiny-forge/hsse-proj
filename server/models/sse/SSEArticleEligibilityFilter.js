...
const SSEArticleEligibilityFilterSchema = new Schema({
  ...
  stakeholderParticipationInPolicyAndOrganizationalDecisionsOrMonitoring: {
    type: Boolean,
    default: false,
  },
  ...
  capsOnCoverageReimbursementForOrganizationsProvidersServicesProducts: {
    type: Boolean,
    default: false,
  },
  priorApprovalRequirementsForOrganizationsProvidersServicesProducts: {
    type: Boolean,
    default: false,
  },
...
SSEArticleEligibilityFilterSchema.methods.isEqualTo = function isEqualTo(otherInput) {
  ...
  SSEArticleEligibilityFilterSchema.eachPath((path) => {
